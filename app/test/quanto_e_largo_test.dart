...
void main() {
  group('le soglie', () {
    ...
    test('il telefono non ha un limite di larghezza: e\' gia\' stretto', () {
  ...
  group('quanto ci sta', () {
    ...
    testWidgets('a chi chiede tutto si da\' tutto', (prova) async {
      prova.view.physicalSize = const Size(3840, 2160);
      prova.view.devicePixelRatio = 2;
      addTearDown(prova.view.reset);
      await prova.pumpWidget(
