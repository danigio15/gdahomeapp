...
const disegniDegliOggetti = <String>{
  'agenda', 'allagamenti', 'allerte', 'aperture', 'aria', 'assistenza',
  'avvisi', 'azioni', 'backup', 'batterie', 'caldaia', 'clima', 'custom',
  'elettrodomestici', 'energia', 'ev', 'evidenza', 'fumo', 'home',
  'impostazioni', 'irrigazione', 'luci', 'media', 'mie', 'minipc', 'persone',
  'piscina', 'prese', 'rifiuti', 'robot', 'runtime', 'scaldabagno',
  'segnalazioni', 'sicurezza', 'solare', 'stanze', 'tapparelle', 'telecamere',
  'temperatura', 'todo', 'ups', 'widget',
};
