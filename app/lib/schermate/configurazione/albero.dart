...
const albero = <Famiglia>[
  ...
  Famiglia('Le pagine', 'Cosa mostra ognuna delle pagine della plancia', [
    ...
    Voce('Solare termico', 'Il boiler solare', disegno: 'solare', da: 'sez3'),
    Voce('Sicurezza', 'Telecamere e allarme', disegno: 'sicurezza', da: 'sez4'),
    Voce('MiniPC', 'Il monitoraggio del server', disegno: 'minipc', da: 'sez6'),
    Voce(
      'Temperatura',
  ...
  Famiglia('Le cose di casa', 'Quello che si accende, si apre e si comanda', [
    ...
    Voce('Prese', 'Le prese comandate', disegno: 'prese', da: 'prese'),
    Voce(
      'Finestre',
