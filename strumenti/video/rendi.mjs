...
const FILM = {
  ...
  /* Le novita' di una versione: un film corto, tutto in dissolvenza, che esce
     a ogni giro che porta cose nuove. Stessa pagina in due misure, come i due
     social. */
  novita: {
    pagina: "novita.html",
    largo: 1080,
  ...
  "novita-quadrato": {
    ...
    alto: 1080,
    posa: { su: 80, giu: 80 },
    uscita: "gdahome-novita-quadrato",
    ritmo: "3400k",
    muto: true,
    copertina: { scena: "novita", quando: 1.6 },
  },
