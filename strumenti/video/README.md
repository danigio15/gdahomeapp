...
**Quello che esce di qui non sta nella repository.** I file pesavano quaranta
megabyte, e sono materiale pubblicitario già pubblicato — su Facebook, su
TikTok, sul sito: chi clona il programma non deve portarseli dietro. Qui
restano gli attrezzi, e il materiale si rifà con un comando
(`.gitignore` tiene fuori quello che ne esce).
