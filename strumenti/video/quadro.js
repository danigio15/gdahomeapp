...
scena(
  ...
  <div class="corpo incolonna">
    ...
    <div class="voci" style="max-width:880px;margin-top:6px">
      ...
      ${voce(q(3, 1.6), "#38bdf8", "2", t('<b>Può fare due sole cose</b>, e solo dove il cliente ha attivato la manutenzione<span class="quando">Avviare un aggiornamento già in attesa, e premere «Riavvia Home Assistant». Nient\'altro</span>', '<b>It can do two things only</b>, and only where the customer enabled maintenance<span class="quando">Start an update already waiting, and press «Restart Home Assistant». Nothing else</span>'))}
    </div>
  </div>
  ${didascalia([
    {
