...
import { computer, MARCHIO, mettiInScena, segno, t } from "./pezzi.js";
...
scena(
  ...
  <div class="corpo incolonna">
    ...
    <div class="vetro pastiglia ap" style="--t:1.3s;border-color:rgba(14,165,233,.45);color:#7dd3fc">
...
scena(
  ...
  <div class="corpo incolonna">
    ...
    <div class="stati" style="margin-top:14px">
      <div class="vetro stato cr" style="--t:1s;border-color:rgba(22,163,74,.5);color:#86efac">
        <span class="segno">●</span>${t("a posto", "all good")}
      </div>
      <div class="vetro stato cr" style="--t:1.2s;border-color:rgba(245,158,11,.5);color:#fcd34d">
        <span class="segno">▲</span>${t("da guardare", "worth a look")}
      </div>
      <div class="vetro stato cr" style="--t:1.4s;border-color:rgba(225,29,72,.5);color:#fda4af">
        <span class="segno">■</span>${t("muta", "silent")}
      </div>
    </div>
  </div>
  ${didascalia([
    ...
    },
    {
      t: 5,
      testo: t(
        "<b>Muta batte tutto:</b> di una casa che non parla non si sa niente, nemmeno che sta bene.",
        "<b>Silent beats everything:</b> a home that isn't talking tells you nothing — not even that it's fine.",
      ),
    },
  ])}`,
);
...
scena(
  ...
  <div class="corpo">
    ...
    <div class="voci" style="max-width:580px">
      ${voce(0.9, "#38bdf8", "1", t('Apri la pagina con la tua chiave, e premi <b>Abbina</b><span class="quando">Niente server da tenere su, niente dominio</span>', 'Open the page with your key and press <b>Pair</b><span class="quando">No server to keep up, no domain</span>'))}
      ${voce(1.25, "#38bdf8", "2", t('Il codice si incolla nella <b>casella dell\'add-on</b><span class="quando">In casa del cliente, e lo fa anche lui: vive un giorno</span>', "The code goes in the <b>add-on's field</b><span class=\"quando\">At the customer's home — it lives a day, so they can do it</span>"))}
      ${voce(1.6, "#38bdf8", "3", t('Il primo rapporto lega il codice a quella casa<span class="quando">E da lì in poi non serve a nessun\'altra</span>', 'The first report binds the code to that home<span class="quando">And from then on it\'s no use to any other</span>'))}
    </div>
  </div>
  ${didascalia([
    {
...
scena(
  ...
  <div class="corpo sovrapposti">
    ${schermo("quadro-elenco", { largo: 740, classe: "cr via", stile: "--t:.4s;--t2:5s" })}
    ${ritaglio({
      foto: "quadro-elenco",
      x: 100,
      y: 362,
...
scena(
  ...
  <div class="corpo sovrapposti">
    ${schermo("quadro-come-sta", { largo: 740, classe: "cr via", stile: "--t:.4s;--t2:5.4s" })}
    ${ritaglio({
...
scena(
  ...
  <div class="corpo incolonna">
    ...
    <div class="voci" style="max-width:880px">
      ${voce(0.9, "#fcd34d", "1", t('<b>La vita del disco</b><span class="quando">Una eMMC ha un numero di scritture, e poi finisce. Vederla salire vuol dire cambiarla quando decidi tu</span>', '<b>Disk life used</b><span class="quando">An eMMC has a number of writes, then it\'s done. Watching it climb means replacing it when you choose</span>'))}
      ${voce(1.25, "#fcd34d", "2", t('<b>La tacca a 75°</b><span class="quando">Sopra, la casa non si rompe: diventa lenta, e nessuno capisce perché</span>', '<b>The mark at 75°</b><span class="quando">Above it the home doesn\'t break: it gets slow, and nobody knows why</span>'))}
      ${voce(1.6, "#fcd34d", "3", t('<b>Un add-on fermo non è un add-on spento</b><span class="quando">Conta solo chi parte all\'avvio ed è giù: quello si è fermato da solo</span>', '<b>A stopped add-on isn\'t a switched-off add-on</b><span class="quando">Only ones set to start on boot count: that one stopped by itself</span>'))}
    </div>
  </div>
  ${didascalia([
    {
...
scena(
  ...
  <div class="corpo sovrapposti">
    ${schermo("quadro-aggiornamenti", { largo: 740, classe: "cr via", stile: "--t:.4s;--t2:5.2s" })}
    ${ritaglio({
...
<span class="chiave">quadro_manutenzione</span>: <span class="numero">false</span>   <span class="nota">${t("# e lasciati aggiornare", "# and let it update you")}</span></div>
    <div class="vetro pastiglia en" style="--t:1.3s;border-color:rgba(14,165,233,.4);color:#cfe1f7;max-width:900px">
    ...
    <p class="occhiello ap" style="--t:1.9s">${t(
...
scena(
  ...
  <div class="corpo incolonna">
    <div class="voci" style="max-width:900px">
      ...
      ${voce(0.8, "#38bdf8", "1", t('<b>Una volta sola</b><span class="quando">Una casa muta da tre giorni è una notizia, non una al giorno</span>', '<b>Once, and once only</b><span class="quando">A home quiet for three days is news, not news every day</span>'))}
...
scena(
  ...
  <div class="corpo incolonna">
    ...
    <div class="voci" style="max-width:880px;margin-top:6px">
      ${croce(1, t("<b>Non apre la plancia</b> — non c'è nessun tasto che porti dentro una casa, e non è un tasto dimenticato", "<b>It doesn't open the dashboard</b> — there's no button into anyone's home, and it isn't a forgotten one"))}
      ${croce(1.3, t("<b>Non vede entità, stanze né persone</b> — riceve numeri, versioni e nomi di processi, e si ferma lì", "<b>It sees no entities, rooms or people</b> — it gets numbers, versions and process names, and stops there"))}
      ${croce(1.6, t("<b>Non tocca niente oltre il suo verbo</b> — e solo dove quella casa ha aperto la manutenzione", "<b>It touches nothing beyond its one verb</b> — and only where that home opened maintenance"))}
    </div>
  </div>
  ${didascalia([
    {
