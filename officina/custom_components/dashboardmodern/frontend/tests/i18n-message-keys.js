...
export const MESSAGE_KEYS = Object.freeze([
  ...
  "“Motion 3C” does not say which room it is.",
  "“pve_qemu_103” does not say what it is.",
  "\"Room - Detail\"",
  ...
  "EVCC solar mix",
  "Even when the sun is not enough",
  "Events",
  ...
  "For those hours Home Assistant doesn't keep the house consumption, so we can't tell how much came from the sun. The band is right all the same.",
  ...
  "Show on the page",
  "Show the cameras under Security",
  "Shown but not controllable",
  "Shown on Home",
  "Shuffle",
  "Shutter closed",
  ...
  "They cost nothing at any hour, and the euros above are only on what it took from the grid.",
