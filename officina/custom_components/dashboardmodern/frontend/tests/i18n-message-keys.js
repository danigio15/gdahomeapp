...
export const MESSAGE_KEYS = Object.freeze([
  ...
  "A floor is already called that.",
  ...
  "Archive",
  "Archived",
  "are left with no floor: they are not deleted.",
  ...
  "Error",
  "Estimated at the average of the bands:",
  "Estimated time",
  "EV profile",
  ...
  "Floor icon",
  "Floor name",
  "Floor name (e.g. Attic)",
  "floors",
  "Floors are created and ordered above, in the Rooms tab.",
  "Flow",
  ...
  "Home Assistant does not keep the oldest hours.",
  ...
  "It has no rooms in it.",
  "it is a blind",
  "it is a climate unit",
  "it is a cover",
  "it is a curtain",
  "it is a door sensor",
  "it is a garage sensor",
  "it is a light",
  "it is a lock",
  "it is a shade",
  "it is a shutter",
  ...
  "it tells whether someone is there",
  "it tells whether the room is busy",
  ...
  "leave empty for the Home Assistant one",
  ...
  "Maximum power (W)",
  "May",
  "Measured hour by hour for the whole month.",
  ...
  "No floor",
  "No floors yet. Add one below: you only need them if the house has more than one.",
  ...
  "Put it in ${nomeDellaSezione(suo)}",
  "Put it out tonight",
  "PV inverter",
  "PV production",
  "Queue unreachable.",
  ...
  "yesterday",
  "you",
  "You already have every floor you can have.",
